        ...
        <div className="min-h-screen bg-background dark:bg-background-dark pt-24 pb-16 px-6 md:px-12 lg:px-24">
            <div className="max-w-4xl mx-auto space-y-16">
                ...
                <section className="space-y-6">
                    ...
                    <div className="prose dark:prose-invert text-muted dark:text-muted-dark space-y-4">
                        <p>
                ...
                <section className="space-y-6">
                    ...
                    <ul className="grid md:grid-cols-2 gap-4 text-lg text-muted dark:text-muted-dark">
                ...
                <section className="space-y-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        <div className="p-6 bg-surface dark:bg-surface-dark rounded-xl border border-gray-200 dark:border-gray-800 space-y-2">
                            ...
                            <h3 className="text-xl font-semibold text-primary dark:text-primary-dark">ReunitePath</h3>
                        ...
                        <div className="p-6 bg-surface dark:bg-surface-dark rounded-xl border border-gray-200 dark:border-gray-800 space-y-2">
                            <h3 className="text-xl font-semibold text-primary dark:text-primary-dark">Renaros</h3>
                            <p className="text-muted dark:text-muted-dark">
